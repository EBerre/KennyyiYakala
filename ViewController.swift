...
//  KennyyiYakala
//
//  Created by GETEM on 29.09.2020.
//
...
class ViewController: UIViewController {
   ...
   @objc func hideKenny(){
    ...
    let random = Int (arc4random_uniform(UInt32(kennyArray.count - 1)))//arrayler [0]dan başladığından 9. eleman yok. o yüzden -1
    ...
    @objc func countDown(){
        ...
        if counter == 0 {
            ...
            //replay function
                self.score = 0 //burada hangi score olduğunu anlamak için self. kullanıyoruz.
